...
namespace GraphEnlargementDemo
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var firstPass = new Subgraph().Apply(graph, (name, inVertex, outVertex) => new MismatchedShoePerson() { Name = name, LeftSize = outVertex.RightSize, RightSize = inVertex.LeftSize});
